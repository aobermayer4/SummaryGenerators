...
if htseq == 1:
	...
	#print(df_merged_counts)
	#print(df_merged_fpkm)
...
if psipso == 1:
	...
	#df_merged_psi_clean.to_csv(r'PSI_Summary_clean.txt', sep = '\t', index = False)
	#psi_filter.to_csv(r'PSI_Filter.txt', sep = '\t', index = False)
	#PSO
	df_merged_pso.to_csv(r'PSO_Summary.txt', sep = '\t', index = False, na_rep = "NaN")
	#df_merged_pso_clean.to_csv(r'PSO_Summary_clean.txt', sep = '\t', index = False)
	#pso_filter.to_csv(r'PSO_Filter.txt', sep = '\t', index = False)
	#3 prime PSI
	df_merged_3ASpsi.to_csv(r'PSI_3_prime_alt_spice_Summary.txt', sep = '\t', index = False, na_rep = "NaN")
	#df_merged_3ASpsi_clean.to_csv(r'PSI_3_prime_alt_spice_Summary_clean.txt', sep = '\t', index = False)
	#psi3AS_filter.to_csv(r'PSI_3_prime_alt_spice_Filter.txt', sep = '\t', index = False)
	#5 prime PSI
	df_merged_5ASpsi.to_csv(r'PSI_5_prime_alt_spice_Summary.txt', sep = '\t', index = False, na_rep = "NaN")
	#df_merged_5ASpsi_clean.to_csv(r'PSI_5_prime_alt_spice_Summary_clean.txt', sep = '\t', index = False)
	#psi5AS_filter.to_csv(r'PSI_3_prime_alt_spice_Filter.txt', sep = '\t', index = False)
